...
def execute():
    ...
    while j < len(line):
        ...
        if len(sub_part) == 2: 
            ...
            result_hasil_eval = evaluate_postfix(infix_to_postfix(expression_to_evaluate), dict_variables)
        ...
        if text.find('jika') != -1:
            ...
            if len (sub_part) == 4:
                ...
                if code_moresubpart == '=':
                    ...
                    # renew = evaluate(change)
                    renew = evaluate_postfix(infix_to_postfix(change), var)
                    var[left_part] = renew
        ...
        if text.find('cetak') != -1:
            ...
            if len(sub_part) == 3:
                ...
                # hasil_eval = evaluate(exp_to_eval)
                hasil_eval = evaluate_postfix(infix_to_postfix(exp_to_eval), var)
